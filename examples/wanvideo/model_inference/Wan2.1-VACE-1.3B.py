...
control_video = VideoData("data/sample/preprocess/vace_video.mp4", height=480, width=832)
mask_video = VideoData("data/sample/preprocess/vace_video_mask.mp4", height=480, width=832)
video = pipe(
    prompt="a photorealistic, cinematic, high-fashion commercial, 360° video of a toy rubber duck as the main product and other toys around it",
    vace_video=control_video,
    vace_video_mask=mask_video,
    seed=1, tiled=True
)
save_video(video, "data/sample/video_output.mp4", fps=24, quality=9)
