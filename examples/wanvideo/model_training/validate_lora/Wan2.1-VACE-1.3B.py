...
seed = 42
np.random.seed(42)
output_dir = "data/target1/outputs/baseline/"
input_dir = "data/target1/"
df = pd.read_csv("data/target1/metadata.csv")
os.makedirs(output_dir, exist_ok=True)
num_inference = 1
lora_path = "models/train/Wan2.1-VACE-1.3B_lora/example1/ohwx/epoch-4.safetensors"
